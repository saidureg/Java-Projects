...
public class addgrocery extends javax.swing.JFrame {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(member_name, javax.swing.GroupLayout.DEFAULT_SIZE, 149, Short.MAX_VALUE)
                    .addComponent(g_name, javax.swing.GroupLayout.DEFAULT_SIZE, 149, Short.MAX_VALUE))
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            String m = member_name.getText(); 
            String g = g_name.getText();
            double q = Double.parseDouble(quantity.getText());
            double p = Double.parseDouble(unit_price.getText());
            t = q * p;
            a = t;
                                  
            String sql = "INSERT INTO GROCERIES(Date,Member_Name,g_name,Quantity,Unit_Price,Total_Amount,Amount) VALUES('" + d +"','" + m +"','" + g +"','"+ q +"','"+ p +"','"+ t +"','"+ a +"')";
